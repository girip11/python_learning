# List of python blog posts to read

* [python `TypedDict`](https://mpkocher.github.io/)
* [Design patterns youtube video](https://www.youtube.com/watch?v=bsyjSW46TDg)
* [Coroutines Effective python](https://effectivepython.com/2015/03/10/consider-coroutines-to-run-many-functions-concurrently)
* [Python patterns and idioms](https://python-3-patterns-idioms-test.readthedocs.io/en/latest/DeveloperGuide.html)
